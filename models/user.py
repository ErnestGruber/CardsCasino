...
class User(db.Model):
    ...
    token = db.Column(db.String(32), unique=True, nullable=False, default=secrets.token_hex(16))  # Токен
    ...
    def __init__(self, bones, not_tokens, username, referral_code=None, referred_by=None, id=None, is_admin=False, wallet_address="0xDefaultWallet"):
        self.id = id
        self.bones = bones
